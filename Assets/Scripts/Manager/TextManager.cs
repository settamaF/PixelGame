...
/*Sample
	TextManager.Get.RequestText("PLAY");
	string.Format(TextManager.Get.RequestText("KILL_MONSTER"), Value);
*/
...
#region Unity Methods	
	...
	{   
	    ...
	    mInstance = this;
		Debug.Log("TextManager loaded", this);
