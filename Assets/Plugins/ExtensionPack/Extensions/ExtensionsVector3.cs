...
public static class ExtensionsVector3
{
	...
	public static Vector3 Divide(this Vector3 v1, Vector2 v2)
	{
		return new Vector3(v1.x / v2.x, v1.y / v2.y, v1.z);
	}
	public static Vector3 Divide(this Vector3 v1, float x, float y)
	{
		return new Vector3(v1.x / x, v1.y / y, v1.z);
	}
	public static Vector3 Divide(this Vector3 v1, float x, float y, float z)
	{
	...
	public static Vector2 LerpTo(this Vector2 from, Vector2 to, float lerp)
	{
